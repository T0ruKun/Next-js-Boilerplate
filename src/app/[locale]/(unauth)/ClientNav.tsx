...
export default function ClientNav() {
  ...
  return (
    <nav className="sticky top-0 z-50 flex size-full bg-white shadow-md">
      <button
        type="button"
        onClick={() => dispatch(toggleSideNav())}
        className="flex size-full min-h-8 max-w-28 justify-center rounded px-3 hover:bg-gray-100"
      >
